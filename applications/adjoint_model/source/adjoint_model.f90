...
!-----------------------------------------------------------------------------
!> @page adjoint model Program

program adjoint_model
  ...
  use adjoint_driver_mod,     only : initialise, step, finalise
